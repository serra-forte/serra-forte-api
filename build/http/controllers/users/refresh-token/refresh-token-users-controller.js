...
var refresh_token_users_controller_exports = {};
__export(refresh_token_users_controller_exports, {
  RefreshToken: () => RefreshToken
});
module.exports = __toCommonJS(refresh_token_users_controller_exports);
...
async function RefreshToken(request, reply) {
  try {
    const refreshTokenBodySchema = import_zod2.z.object({
