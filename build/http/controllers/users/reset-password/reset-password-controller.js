...
var reset_password_controller_exports = {};
__export(reset_password_controller_exports, {
  ResetPassword: () => ResetPassword
});
module.exports = __toCommonJS(reset_password_controller_exports);
...
async function ResetPassword(request, reply) {
  try {
    ...
    const userSchemaQuery = import_zod.z.object({
