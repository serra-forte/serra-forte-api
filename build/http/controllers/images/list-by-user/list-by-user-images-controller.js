...
var list_by_user_images_controller_exports = {};
__export(list_by_user_images_controller_exports, {
  ListImageByUser: () => ListImageByUser
});
module.exports = __toCommonJS(list_by_user_images_controller_exports);
...
async function ListImageByUser(request, reply) {
  try {
    const imageSchemaParms = import_zod.z.object({
