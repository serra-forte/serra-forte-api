...
// src/usecases/users/reset-password/reset-password-test.spec.ts
...
var ResetPasswordUseCase = class {
  ...
  async execute({
    ...
    const newPassword = await (0, import_bcrypt2.hash)(password, 8);
...
var registerUseCase;
var stu;
(0, import_vitest.describe)("Reset password (unit)", () => {
  (0, import_vitest.beforeEach)(async () => {
    ...
    await usersRepositoryInMemory.create({
      ...
      name: "John Doe",
      phone: "77-77777-7777",
      password: await (0, import_bcrypt3.hash)("123456", 8)
    });
  ...
  (0, import_vitest.test)("Should be able to reset passwod account", async () => {
    ...
    const updateUserPassword = await usersRepositoryInMemory.findByEmail(user.email);
    (0, import_vitest.expect)(updateUserPassword.password !== oldPassword).toBeTruthy();
  });
});
