...
// src/usecases/address/create/create-address-test.spec.ts
...
var stu;
(0, import_vitest.describe)("Create address (unit)", () => {
  ...
  (0, import_vitest.test)("Should not be able to update a address with invalid user", async () => {
