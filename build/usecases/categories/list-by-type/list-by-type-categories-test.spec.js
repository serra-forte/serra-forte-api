...
// src/usecases/categories/list-by-type/list-by-type-categories-test.spec.ts
...
var stu;
(0, import_vitest.describe)("List categories by type (unit)", () => {
  ...
  (0, import_vitest.test)("Should be able to list Category by type", async () => {
    for (let i = 0; i < 10; i++) {
