...
// src/usecases/categories/delete/delete-categories-test.spec.ts
...
var stu;
(0, import_vitest.describe)("Delete category (unit)", () => {
  ...
  (0, import_vitest.test)("Should be able to delete Category", async () => {
  ...
  (0, import_vitest.test)("Should not be able to delete Category with invalid id", async () => {
