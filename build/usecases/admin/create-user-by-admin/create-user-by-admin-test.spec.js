...
// src/usecases/admin/create-user-by-admin/create-user-by-admin-test.spec.ts
...
var stu;
(0, import_vitest.describe)("Create user by admin (unit)", () => {
  ...
  (0, import_vitest.test)("Should be able to register a new account", async () => {
  ...
  (0, import_vitest.test)("Should not be able to register a new account with user admin invalid", async () => {
    await (0, import_vitest.expect)(
      () => stu.execute({
